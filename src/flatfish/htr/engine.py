...
from flatfish.htr.models import HTRModel, get_model, image_to_base64
from flatfish.utils.images import prepare_for_ocr
from flatfish.utils.logging import get_logger
from flatfish.utils.text import clean_extracted_text
...
class HTREngine:
    ...
    def model(self) -> HTRModel:
        ...
        if self._model is None:
            api_key = self.env.dashscope_api_key if self.env else None
            self._model = get_model(model_type="default", api_key=api_key)
        return self._model
